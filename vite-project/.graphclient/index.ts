...
export type MeshContext = UniswapV4Base_3Types.Context & BaseMeshContext;
...
const uniswapV4Base_3Handler = new GraphqlHandler({
              ...
              config: {"endpoint":"https://gateway.thegraph.com/api/a19f1dd06e06b56904ed2c04d64a7c39/subgraphs/id/Gqm2b5J85n1bhCyDMpGbtbVn4935EvvdyHdHrx3dibyj"},
              baseDir,
              cache,
              pubsub,
...
const documentHashMap = {
        "99afc8821e37b4012d142b4bda063f4efde1cd091fc9efe1f454442a26c3a53a": GetPoolManagersDocument
      }
  ...
  return {
    ...
    get documents() {
      return [
      {
        ...
        sha256Hash: '99afc8821e37b4012d142b4bda063f4efde1cd091fc9efe1f454442a26c3a53a'
      }
    ];
    },
    fetchFn,
