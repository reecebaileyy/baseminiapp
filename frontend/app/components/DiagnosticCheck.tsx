    ...
    <div style={{
      ...
      <div style={{ marginBottom: '10px' }}>
        ...
        <ul style={{ marginLeft: '20px' }}>
          <li>
            API Key: {process.env.NEXT_PUBLIC_ONCHAINKIT_API_KEY 
              ? '✅ Set' 
              : '❌ Missing'}
          </li>
          <li>
            Project ID: {process.env.NEXT_PUBLIC_ONCHAINKIT_PROJECT_ID 
              ? `✅ Set (${process.env.NEXT_PUBLIC_ONCHAINKIT_PROJECT_ID.substring(0, 8)}...)` 
              : '❌ Missing'}
          </li>
        </ul>
      </div>
      ...
      {hasAuthError && (
        <div style={{
          ...
          <ol style={{ marginLeft: '20px', marginBottom: 0 }}>
            ...
            <li>Update <code>frontend/.env.local</code> with the new key</li>
            <li>Restart dev server</li>
          </ol>
          <p style={{ margin: '8px 0 0 0', fontSize: '0.85em' }}>
            📖 See <code>frontend/FIX_401_ERROR.md</code> for detailed instructions
          </p>
        </div>
      )}

      {(!process.env.NEXT_PUBLIC_ONCHAINKIT_API_KEY || !process.env.NEXT_PUBLIC_ONCHAINKIT_PROJECT_ID) && (
        <div style={{
          background: 'rgba(239, 68, 68, 0.1)',
          ...
          <ol style={{ marginLeft: '20px', marginBottom: 0 }}>
            <li>Create <code>.env.local</code> in the frontend directory</li>
            <li>Add:
