...
export default function TokenDetails({ params }: { params: Promise<{ address: string }> }) {
    ...
    return (
      <div className={styles.container}>
        ...
        <div className={styles.error}>
          ...
          <Link href="/dashboard">Back to Scanner</Link>
        </div>
      </div>
    );
  }
      ...
      <div className={styles.content}>
        <div className={styles.tokenHeader}>
          <div className={styles.tokenIcon}>
            {token.logoURI ? (
              <Image src={token.logoURI} alt={token.symbol} width={64} height={64} />
            ) : (
